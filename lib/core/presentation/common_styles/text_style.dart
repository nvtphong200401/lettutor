...
class CommonTextStyle {
  ...
  static const partTitle = TextStyle(fontSize: 17);
  static const partContent = TextStyle(fontSize: 17);
  static const partTitleDesc = TextStyle(fontSize: 16, fontWeight: FontWeight.w700);
  static const partDesc = TextStyle(fontSize: 14, color: ColorName.partDesc);
// style in course screen
  static const titleCourse = TextStyle(fontSize: 22, fontWeight: FontWeight.w600);
