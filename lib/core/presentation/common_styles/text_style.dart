...
class CommonTextStyle {
  ...
  static const partContent =
      TextStyle(fontSize: 17, color: ColorName.textColor);
  static const partTitleDesc = TextStyle(
...
// style in course screen
  static const titleCourse = TextStyle(
      fontSize: 22, color: ColorName.textColor, fontWeight: FontWeight.w600);
  static const descCourse =
      TextStyle(fontSize: 12, color: ColorName.courseDesc);
}
